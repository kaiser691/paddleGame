...
class Start{
    ...
    info(){
        ...
        fill(0);
        text("To play: move the mouse to make the paddle",(this.w/2)-190,300);
        text("move to prevent the ball from falling down.",(this.w/2)-190,320);
